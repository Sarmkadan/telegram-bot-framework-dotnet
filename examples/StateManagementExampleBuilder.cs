...
namespace TelegramBotFramework.Examples
{
    ...
    /// </summary>
    public class StateManagementExampleBuilder
    {
        ...
        public StateManagementExampleBuilder WithFirstName(string firstName)
        {
        ...
        public StateManagementExampleBuilder WithEmail(string email)
        {
        ...
        public StateManagementExampleBuilder WithPhoneNumber(string phoneNumber)
        {
        ...
        public StateManagementExampleBuilder WithSatisfactionLevel(int satisfactionLevel)
        {
        ...
        public StateManagementExampleBuilder WithImprovementSuggestions(string improvementSuggestions)
        {
        ...
        /// <returns>The builder instance for method chaining.</returns>
        public StateManagementExampleBuilder WithWouldRecommend(bool wouldRecommend)
        {
        ...
        /// <summary>
        /// Creates a StateManagementExampleBuilder pre-populated from an existing StateManagementExample instance.
        /// </summary>
        ...
        public static StateManagementExampleBuilder From(StateManagementExample template)
        {
            ArgumentNullException.ThrowIfNull(template);
            return new StateManagementExampleBuilder()
