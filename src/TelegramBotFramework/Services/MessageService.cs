...
public sealed class MessageService : IMessageService
{
    ...
    public async Task<IList<Models.Message>> GetUserMessagesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var userMessages = await _messageRepository.GetByUserIdAsync(userId, cancellationToken);
        return userMessages
    ...
    public async Task<IList<Models.Message>> GetFailedMessagesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var failedMessages = await _messageRepository.GetByStatusAsync(Models.MessageStatus.Failed, cancellationToken);
    ...
    {
        var processingMessages = await _messageRepository.GetByStatusAsync(Models.MessageStatus.Processing, cancellationToken);
        var receivedMessages = await _messageRepository.GetByStatusAsync(Models.MessageStatus.Received, cancellationToken);
