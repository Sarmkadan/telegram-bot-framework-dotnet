...
/// <summary>
/// Provides additional System.Text.Json serialization and deserialization helpers for <see cref="PollingStrategy"/>.
/// </summary>
public static class PollingStrategyJsonExtensionsJsonExtensions
{
    ...
    public static string ToJsonNew(this PollingStrategy value, bool indented = false)
    {
    ...
    public static PollingStrategy? FromJsonNew(string json)
    {
    ...
    public static bool TryFromJsonNew(string json, out PollingStrategy? value)
    {
        value = null;
